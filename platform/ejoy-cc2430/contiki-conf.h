...
* Uart0 Configuration
* By MW
* Our ejoy-cc2430 hardware design is for UART0 with 4-wired P0 i/o port.
* Let's make it nice.
* 2012.3.12
*/

/*
* UART0:On Ejoy-CC2430,We use UART0 as our Serial Line connection.
* On hardware,there is a CH340T to convert the serial line to USB port to PC 
* Based on CC2430 Data Sheet (rev. 2.1)   SWRS036F , "13.14 USART"
* We need to config the UART0 with four-wire interface consisting of the pins RXD,TXD,RTS,CTS
* What's more, we also make configurations for interrupt and achieve functions when we recieve and send the data. 
* by MW
*/
#ifndef UART_ZERO_CONF_ENABLE
...
/*
* Temporarily, we don't handle the input from UART0.
*/


/*
* Temporarily,we don't enable SLIP bridge, while when we build a Gateway for WSN and Ethernet, it's a must.
*/
